...
namespace EntregaProyecto2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            ProfilelUser perfi2 = new ProfilelUser();
            double intervalo = 1000;
            Reproductor reproductor = new Reproductor(intervalo);
            List<SongClass> cola = new List<SongClass>();
                                                ...
                                                if (diccUserProfiles.ContainsKey(user1) == true)
                                                {
                                                    if (diccUserProfiles[user1].Count <= 5)
                                                    {
                                                        ...
                                                        if (diccUserProfiles.ContainsKey(user1) == true)
                                                        {
                                                           ...
                                                           // SaveDic(diccUserProfiles);
                                                            //diccUserProfiles = LoadDictionary();
                                                        }
                                                    }
                                                    else
                                                    {
                                    ...
                                    if (listaperfiles.Count > 0)
                                    {
                                        ...
                                        while (true)
                                        {
                                            ...
                                            else if (menuPerfil == 3)
                                            {
                                                while(true)
                                                {
                                                    Console.WriteLine("Buscar Canciones \n1)Buscar por Compositor \n2)Buscar por palabra clave \n3)Buscar por cantante  \n4)Salir");
                                                    string qq = Console.ReadLine();
                                                    int opbuscar = Int32.Parse(qq);
                                                    if (opbuscar == 1)
                                                    {
                                                        SongClass cancion1=search.SearchForComposer();
                                                        Console.WriteLine("Desea seguir el cantante \n1)Si \n2)No");
                                                        string vv = Console.ReadLine();
                                                        int op1 = Int32.Parse(vv);
                                                        Console.WriteLine("Desea seguir el Disco? \n1)Si \n2)No");
                                                        string vv1 = Console.ReadLine();
                                                        int op2 = Int32.Parse(vv1);
                                                        
                         
                                                        while (true)
                                                        {
                                                            Console.WriteLine("Desea descargar la cancion? \n1)Si \n2)No");
                                                            string vv2 = Console.ReadLine();
                                                            int op3 = Int32.Parse(vv2);
                                                            if (op3 == 1)
                                                            {
                                                                perfi2.Download(cancion1);
                                                            }
                                                            else if(op3==2)
                                                            {
                                                                break;
                                                            ...
                                                            {
                                                                Console.WriteLine("numero invalido, ingreselo de nuevo");
                                                            }
                                                        }
                                                        ...
                                                        while (true)
                                                        {
                                                            ...
                                                            string vv3 = Console.ReadLine();
                                                            int op4 = Int32.Parse(vv3);
                                                        ...
                                                        while (true)
                                                        {
                                                            Console.WriteLine("Desea detener la cancion? \n1)Si \n2)No");
                                                            string vv9 = Console.ReadLine();
                                                            int op8 = Int32.Parse(vv9);

                                                            if (op8 == 1)
                                                            {
                                                                TimeSpan final = reproductor.Detener();
                                                            }
                                                            else if (op8 == 2)
                                                            {
                                                                break;
                                                        ...
                                                        Console.WriteLine("Desea Agregar imagen al disco?\n1)Si \n2)No");
                                                        string vv4 = Console.ReadLine();
                                                        int op6 = Int32.Parse(vv4);
                                                        Console.WriteLine("Desea darle like?\n1)Si \n2)No");
                                                        string vv5 = Console.ReadLine();
                                                        int op7 = Int32.Parse(vv5);
                                       
                                                        while (true)
                                                        {
                                                            Console.WriteLine("Desea agregar a la cola? \n1)Si \n2)No");
                                                            string vv0 = Console.ReadLine();
                                                            int op99 = Int32.Parse(vv0);
                                                    ...
                                                    {
                                                        SongClass cancion1 = search.SearchKeyWordSong();
                                                        Console.WriteLine("Desea seguir el cantante \n1)Si \n2)No");
                                                        string vv = Console.ReadLine();
                                                        int op1 = Int32.Parse(vv);
                                                        Console.WriteLine("Desea seguir el Disco? \n1)Si \n2)No");
                                                    ...
                                                    else if (opbuscar == 3)
                                                    {
                                                        ...
                                                        SongClass cancion1 = search.SearchSinger();
                                                        Console.WriteLine("Desea seguir el cantante \n1)Si \n2)No");
                                                        string vv = Console.ReadLine();
                                                        int op1 = Int32.Parse(vv);
                                                        Console.WriteLine("Desea seguir el Disco? \n1)Si \n2)No");
                                            ...
                                            {
                                                Console.WriteLine("Buscar Videos");
